...
let personal_circle = document.querySelector('.personal-circle');
let company_circle = document.querySelector('#company-circle');
let gstin_company_container = document.querySelectorAll('.gstin-company-container');
let form_company = document.querySelectorAll('.form-sign-up-company');
let form_personal = document.querySelectorAll('.form-sign-up');
let personal_background = document.querySelectorAll('.personal-circle-background')
console.log(gstin_company_container,'gstin');
...
let circle_company_clicked = false;
// personal_circle.addEventListener('click', (event)=>{
//     console.log('inside add event');
//    // gstin_company_container[0].style.display = 'none';
//     // gstin_company_container[0].classList.add('disable');
//     form_company[0].style.display = 'none';
//     form_personal[0].style.display = 'block';
//     personal_circle.style.backgroundColor = 'black';
//     company_circle.style.backgroundColor = 'white';
// })

// company_circle.addEventListener('click', (event) => {
//     console.log('inside company circle');
//     form_personal[0].style.display = 'none';
//     form_company[0].style.display = 'block';
//   //  gstin_company_container[0].style.display = 'flex';
//     company_circle.style.backgroundColor = 'black';
//     personal_circle.style.backgroundColor = 'white';
// })
